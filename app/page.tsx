      ...
      <section className="h-screen flex flex-col items-center justify-between py-12 md:py-16 px-4">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-6xl px-2">
          ...
          <MagneticButton>
            <Link 
              href="/dance-fitness"
              className="group relative h-48 md:h-56 rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105 block"
            >
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto w-full text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <MagneticButton>
              <Link 
                href="/register" 
                className="button-primary px-8 py-4 rounded-full text-base font-semibold block"
              >
                Register / Book Now
              </Link>
            </MagneticButton>
            <MagneticButton>
              <Link 
                href="/dance-fitness" 
                className="button-ghost px-8 py-4 rounded-full text-base font-semibold block"
              >
                Explore Services
              </Link>
            </MagneticButton>
